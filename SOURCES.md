...
| 2.2d | 108 is attributable to Satoh et al., ASIACRYPT 2001 | **VERIFIED, with nuance** | Satoh et al.'s own Tab. 1 reports **152** (the naive count). Kranz et al. (ePrint 2017/1151) Tab. 3 lists AES as naive 152, **Paar1 108**, BP 97, and writes verbatim: *"An implementation with 108 XORs has been presented in [BBR16a; BBR16b; Sat+01]"* — i.e. the field attributes 108 jointly to Banik–Bogdanov–Regazzoni (Atomic-AES, 2016, two versions) and Satoh et al. Cite it the way the literature does. |
